<template>
        <div>
            ...
            <!--<div class="ms-doc">-->
                ...
                <!--</article>-->
            <!--</div>-->
            <div id="myChart" :style="{width:'100%',height:'600px'}" ref="myChart"></div>
        </div>
</template>
...
<script>
    export default {
        ...
        methods:{
            ...
            getTableData(){
                let self = this
                this.$axios.get('/static/charts.json',{
                    baseURL: '',
                }).then((res)=>{
                    res.data.forEach(function (e,i) {
                        self.xdata.push(e.day)
                        self.ydata.push(e.borrowOrderCount)
                        self.y2data.push(e.acceptUserCount)
                        self.drawLine()
                    })
